...
export PYTHONPATH=$HOME/notebooks/f_factors/source/m5_by_amp/:$HOME/notebooks/datacat-utilities/python:$HOME/notebooks/eTraveler-clientAPI/python:$HOME/notebooks/EO-plotsDisplays/python:$PYTHONPATH
bokeh serve $HOME/notebooks/EO-plotsDisplays/python/serveRenderFP.py --allow-websocket-origin=localhost:5006 --args -e SR_emulation_config.txt --hook m5_hook -t "User m5 u"
