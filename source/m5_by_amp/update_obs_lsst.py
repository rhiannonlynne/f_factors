...
for i in range(len(sensors)):
    my_folder = f"{os.environ['OBS_LSST_DATA_DIR']}/lsstcam/qe_curves/{installed_raft.lower()}_{sensors[i].lower()}"
...
for i in range(len(sensors)):
    srcDir = f"{os.environ['OBS_LSST_DATA_DIR']}/ts8/qe_curves/{rtmname.lower()}_{sensors[i].lower()}"
    destDir = f"{os.environ['OBS_LSST_DATA_DIR']}/lsstcam/qe_curves/{installed_raft.lower()}_{sensors[i].lower()}"
